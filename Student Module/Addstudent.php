...
if(mysqli_num_rows(mysqli_query($conn1,"SELECT * from college_database.stud_table where s_gr=".$_POST["s_gr"]))==0)
{
	$return_data["dataexist"]="no";
}
