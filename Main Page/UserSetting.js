...
$(document).ready(function() {
    if (typeof InstallTrigger !== 'undefined') {
        // $(".slidingMenu").css("height", "43.2em");
        $(".slidingMenu").css("height", "45em");
        $(".logo-outer-circle").css("margin-top", "76px");
        $(".pmsName").css("margin-top", "8em");
        $(".chats").css("margin-top", "336px");
        $(".stagesInstru").css("margin-top", "407px");
        $(".visitCollegeSite").css("margin-top", "477.5px");
        $(".darkMode").css("margin-top", "548px");
        $(".finalizeProject").css("margin-top", "619px");
        $(".bluePartIncrease").css("margin-top", "43.1em");
...
$(document).ready(function() {
    ...
    $(".visitCollegeSite").click(function(){
        window.location = "https://www.dnyanasadhanacollege.org/";
    });
...
function viewMore(){
    $(".recordComplition").css("height","75em");
    setTimeout(function(){$(".rc3").css("display","block")},200);
    setTimeout(function(){$(".rc4").css("display","block")},400);
    setTimeout(function(){$(".rc5").css("display","block")},600);
    setTimeout(function(){$(".rc6").css("display","block")},800);
    setTimeout(function(){$(".rc7").css("display","block")},1000);
    $(".viewMore1").css("display", "none");
    $(".viewMore2").css("display", "block");
}

function lessMore(){
    $(".recordComplition").css("height","29.5em");
    setTimeout(function(){$(".rc3").css("display","none")},800);
    setTimeout(function(){$(".rc4").css("display","none")},650);
    setTimeout(function(){$(".rc5").css("display","none")},450);
    setTimeout(function(){$(".rc6").css("display","none")},300);
    setTimeout(function(){$(".rc7").css("display","none")},150);
...
$(document).ready(function(){
    ...
    $(".privacyPolicy, .clickHereFaqs4").click(function(){
        window.location = "https://www.privacypolicies.com/privacy/view/2f05fc24aec2c1c007141a503dadd280";
    });
});
