    ...
    jQuery.ajax({
        ...
        success: function(results){
        	...
        	if(results["update"] == "no"){
        		wrongVal("Sorry", "No records were updated");
        		...
        		rightVal("Success", "Record Edited Successfully");
        	}
	...
	jQuery.ajax({
        ...
        success: function(results){
            ...
            if(results["update"] == "yes"){
            	rightVal("Success!", "Record Deleted Successfully");
...
function adeletealldatabtn(){
	jQuery.ajax({
        ...
        success: function(results){
            $(".outer_addalldata").fadeOut();
            if(results["update"] == "yes"){
            	rightVal("Success!", "All Record Deleted Successfully");
            	load_data(outer_page, outer_records_per_page,$("#actiStat").attr("activeState"));
            }else{
            	wrongVal("Sorry!", "Something Went Wrong");
            }
...
function admin_email(data_pos){
    ...
    if(checkStatus == "Active"){
		...
		$(".alldeletemess").text("Are you sure to Send Email of Admin.");
	    $(".same_iadaase").hide();
