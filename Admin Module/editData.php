...
require_once 'conn.php';
      ...
      if($editdelete == "aedit"){
            ...
            $msg="<html><body><h1>Hi ".explode("@",$email_id)[0].",</h1> <div style='font-size:1.5em'><p>A new Account Has been created for You.</p><p>Click the url below to activate your account and select a password!</p><p>Admin%20Module/setPassword.php?vkey=$vkey&source=$source</p><p>If the above URL does not work try copying and pasting it into your browser. If you continue to have problems, please feel free to contact us.</p><p>Regards Admin.</p><div></body></html>";
            ...
            if($_POST["source"]=="teacher"){
                  ...
                  if(($rows[0])==0){
                        ...
                        for($i=0;$i<$row1;$i++)
                        {
                              ...
                              $msg="<html><body><h1>Hi ".$row['t_name'].",</h1> <div style='font-size:1.5em'><p>A new Account Has been created for You.</p><p>Click the url below to activate your account and select a password!</p><p>Admin%20Module/setPassword.php?vkey=$vkey&source=$source</p><p>If the above URL does not work try copying and pasting it into your browser. If you continue to have problems, please feel free to contact us.</p><p>Regards Admin.</p><div></body></html>";
                              $msg=nl2br($msg);
                              $headers = "MIME-Version: 1.0" . "\r\n";
                              $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
                              $headers .= 'From: PROJECT MANAGEMENT SYSTEM<cartoonlovers185@gmail.com>' . "\r\n";
