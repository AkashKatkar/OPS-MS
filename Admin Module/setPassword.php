		...
		<form id="main-container" method="POST">
			...
			<div class="mainBox">
	            ...
	            <div class="outer_AddAdminBtn">
		            <input type="button" value="Add Admin" id="Admin_submit" class="AddAdminBtns" onclick="setpassword_admin()">
		        </div>
			</div>
		</form>
		</div>
	    	...
	    	jQuery.ajax({
				...
				success: function(results){
					...
					if(results["updated"]=="true"){
						...
						if(source == "student"){
							setTimeout(function(){
					            location.href="Student Module/StudentLogin.php";
					        },2000);
						}else if(source == "teacher"){
					        setTimeout(function(){
					            location.href="Teacher Module/TeacherLogin.php";
					        },2000);
					    }else{
							setTimeout(function(){
