<?php
	...
	if(!empty(extract($_POST)))
	{
		...
		$msg="<html><body><h1>Hi ".explode("@",$user_name)[0].",</h1> <div style='font-size:1.5em'><p>A new Account Has been created for You.</p><p>Click the url below to activate your account and select a password!</p><p>Admin%20Module/setPassword.php?vkey=$vkey&source=$source</p><p>If the above URL does not work try copying and pasting it into your browser. If you continue to have problems, please feel free to contact us.</p><p>Regards Admin.</p><div></body></html>";
				...
				if(aname == "" || aname == null){
					...
					jQuery.ajax({
						...
						success: function(results){
							...
							{
								$(".AddAdminBtn").attr("onclick", "addadmin()");
								wrongVal("Sorry","Phone Number Already Exists");
							}
						}
					});
				}
